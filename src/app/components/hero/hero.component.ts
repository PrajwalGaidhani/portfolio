    ...
    <section class="hero">
      <div class="hero-container">
        <div class="hero-content animate-fade-in">
          <h1>Hi, I'm <span class="gradient-text">Prajwal Gaidhani</span></h1>
          <p class="subtitle">Software Consultant • Full Stack Developer • Problem Solver</p>
          <p class="description">
            I design and build scalable systems with Python, Java, and React. Passionate about automation, microservices, and creating solutions that drive real impact. AWS & system design enthusiast.
          </p>
          ...
          <div class="social-links">
            ...
            <a href="mailto:prajwalgaidhani18@gmail.com" title="Email">
