    ...
    <section class="hero">
      <div class="hero-container">
        <div class="hero-content animate-fade-in">
          ...
          <p class="subtitle">Full Stack Developer • UI/UX Enthusiast • Problem Solver</p>
          <p class="description">
            I craft beautiful and functional digital experiences with modern technologies.
            Passionate about clean code, responsive design, and creating solutions that matter.
          </p>
